...
import (
	...
	"xlr8d.io/uplink/private/storage/streams/buffer"
)
...
type Options struct {
	...
	Params oss.EncryptionParameters
...
func (s *Splitter) Next(ctx context.Context) (Segment, error) {
	...
	var contentKey oss.Key
	var keyNonce oss.Nonce
	...
	if s.opts.Params.CipherSuite == oss.EncNull ||
		s.opts.Params.CipherSuite == oss.EncNullBase64URL {
