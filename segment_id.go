...
// PackSegmentID takes a satellite signer and a segment ID and returns a oss.SegmentID.
func PackSegmentID(ctx context.Context, satellite signing.Signer, satSegmentID *SegmentID) (segmentID oss.SegmentID, err error) {
	...
	segmentID, err = oss.SegmentIDFromBytes(encodedSegmentID)
	if err != nil {
		return nil, err
	}
