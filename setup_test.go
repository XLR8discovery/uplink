...
func TestConfigFromEnv(t *testing.T) {
	...
	t.Run("enabled with default values", func(t *testing.T) {
		t.Setenv("OSS_STALL_DETECTION_ENABLED", "true")
	...
	t.Run("enabled with custom values", func(t *testing.T) {
		t.Setenv("OSS_STALL_DETECTION_ENABLED", "true")
		t.Setenv("OSS_STALL_DETECTION_BASE_UPLOADS", "5")
		t.Setenv("OSS_STALL_DETECTION_FACTOR", "3")
		t.Setenv("OSS_STALL_DETECTION_MIN_DURATION", "30s")
		t.Setenv("OSS_STALL_DETECTION_DYNAMIC_BASE", "true")
	...
	t.Run("enabled with invalid env values", func(t *testing.T) {
		t.Setenv("OSS_STALL_DETECTION_ENABLED", "true")
		t.Setenv("OSS_STALL_DETECTION_BASE_UPLOADS", "invalid")
		t.Setenv("OSS_STALL_DETECTION_FACTOR", "not-a-number")
		t.Setenv("OSS_STALL_DETECTION_MIN_DURATION", "invalid-duration")
		t.Setenv("OSS_STALL_DETECTION_DYNAMIC_BASE", "not-true")
	...
	t.Run("case insensitive enabled flag", func(t *testing.T) {
		...
		for _, enabled := range testCases {
			t.Run("enabled="+enabled, func(t *testing.T) {
				t.Setenv("OSS_STALL_DETECTION_ENABLED", enabled)
				config := ConfigFromEnv()
