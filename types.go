...
type SegmentEncryption struct {
	...
	EncryptedKey      oss.EncryptedPrivateKey
}
...
type ListOptions struct {
	Prefix                oss.Path
	Cursor                oss.Path // Cursor is relative to Prefix, full path is Prefix + Cursor
	CursorEnc             []byte
	VersionCursor         []byte
	Delimiter             string
	Recursive             bool
