...
import (
	...
	"xlr8d.io/common/pb"
	"xlr8d.io/common/oss"
	"xlr8d.io/uplink/private/testuplink"
)
...
type PiecePutter interface {
	...
	// cancelled.
	PutPiece(longTailCtx, uploadCtx context.Context, limit *pb.AddressedOrderLimit, privateKey oss.PiecePrivateKey, data io.ReadCloser) (hash *pb.PieceHash, deprecated *struct{}, err error)
}
...
func UploadOne(longTailCtx, uploadCtx context.Context, manager *Manager, putter PiecePutter, privateKey oss.PiecePrivateKey, stallManager *StallManager) (_ bool, err error) {
