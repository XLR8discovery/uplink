...
func (failExchange) ExchangeLimits(ctx context.Context, segmentID oss.SegmentID, pieceNumbers []int) (oss.SegmentID, []*pb.AddressedOrderLimit, error) {
...
func (f fakeExchanger) ExchangeLimits(ctx context.Context, segmentID oss.SegmentID, pieceNumbers []int) (oss.SegmentID, []*pb.AddressedOrderLimit, error) {
	if len(segmentID) != 1 {
...
func makeSegmentID(rev revision) oss.SegmentID {
	return oss.SegmentID{rev.value}
}
