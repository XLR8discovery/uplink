...
import (
	...
	"xlr8d.io/common/context2"
	"xlr8d.io/common/errs2"
	"xlr8d.io/common/pb"
	"xlr8d.io/common/signing"
	"xlr8d.io/common/oss"
	"xlr8d.io/common/sync2"
	"xlr8d.io/eventkit"
)
...
func (client *Client) Download(ctx context.Context, limit *pb.OrderLimit, piecePrivateKey oss.PiecePrivateKey, offset, size int64) (_ *Download, err error) {
		...
		if notYetReceived < client.orderStep {
			...
			if newAllocation > 0 {
				...
				err = func() error {
					...
					if client.client.NodeURL().NoiseInfo.Proto != oss.NoiseProto_Unset {
