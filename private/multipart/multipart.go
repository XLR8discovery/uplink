...
//go:linkname dialMetainfoClient xlr8d.io/uplink.dialMetainfoClient
...
//go:linkname encryptPath xlr8d.io/uplink.encryptPath
func encryptPath(project *uplink.Project, bucket, key string) (paths.Encrypted, error)

//go:linkname deriveContentKey xlr8d.io/uplink.deriveContentKey
func deriveContentKey(project *uplink.Project, bucket, key string) (*oss.Key, error)
