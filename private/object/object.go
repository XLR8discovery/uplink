...
import (
	...
	"xlr8d.io/common/rpc/rpcstatus"
	"xlr8d.io/common/oss"
	"xlr8d.io/uplink"
	"xlr8d.io/uplink/internal/expose"
	privateBucket "xlr8d.io/uplink/private/bucket"
	"xlr8d.io/uplink/private/metaclient"
	privateProject "xlr8d.io/uplink/private/project"
	"xlr8d.io/uplink/private/storage/streams"
)
...
// VersionedDownload is a download from OSS Network.
...
func GetObjectIPSummary(ctx context.Context, config uplink.Config, access *uplink.Access, bucket, key string) (_ *IPSummary, err error) {
	...
	db := metaclient.New(metainfoClient, oss.EncryptionParameters{}, expose.AccessGetEncAccess(access).Store)
...
//go:linkname convertKnownErrors xlr8d.io/uplink.convertKnownErrors
func convertKnownErrors(err error, bucket, key string) error

//go:linkname dialMetainfoDB xlr8d.io/uplink.dialMetainfoDB
func dialMetainfoDB(ctx context.Context, project *uplink.Project) (_ *metaclient.DB, err error)

//go:linkname encryptionParameters xlr8d.io/uplink.encryptionParameters
func encryptionParameters(project *uplink.Project) oss.EncryptionParameters

//go:linkname objectETag xlr8d.io/uplink.objectETag
func objectETag(object *uplink.Object) []byte

//go:linkname objectVersion xlr8d.io/uplink.objectVersion
func objectVersion(object *uplink.Object) []byte

//go:linkname objectIsVersioned xlr8d.io/uplink.objectIsVersioned
func objectIsVersioned(object *uplink.Object) bool

//go:linkname objectIsLatest xlr8d.io/uplink.objectIsLatest
func objectIsLatest(object *uplink.Object) bool

//go:linkname downloadObjectWithVersion xlr8d.io/uplink.downloadObjectWithVersion
...
//go:linkname download_getMetaclientObject xlr8d.io/uplink.download_getMetaclientObject
func download_getMetaclientObject(dl *uplink.Download) *metaclient.Object

//go:linkname uploadObjectWithRetention xlr8d.io/uplink.uploadObjectWithRetention
...
//go:linkname commitUpload xlr8d.io/uplink.commitUpload
...
//go:linkname upload_getMetaclientObject xlr8d.io/uplink.upload_getMetaclientObject
func upload_getMetaclientObject(u *uplink.Upload) *metaclient.Object

//go:linkname upload_getStreamMeta xlr8d.io/uplink.upload_getStreamMeta
func upload_getStreamMeta(u *uplink.Upload) *streams.Meta

//go:linkname upload_setETag xlr8d.io/uplink.upload_setETag
