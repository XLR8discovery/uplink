...
// NewRedundancyStrategyFromOSS creates new RedundancyStrategy from the given
// oss.RedundancyScheme.
func NewRedundancyStrategyFromOSS(scheme oss.RedundancyScheme) (RedundancyStrategy, error) {
