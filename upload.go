...
func (client *Client) UploadReader(ctx context.Context, limit *pb.OrderLimit, piecePrivateKey oss.PiecePrivateKey, data io.Reader) (hash *pb.PieceHash, err error) {
